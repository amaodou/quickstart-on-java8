...
public class HTMLColors {
    ...
    public static Map<String, Integer> INVERT_MAP = invert(MAP);

    public static Integer rgb(String colorName) {
        return INVERT_MAP.get(colorName);
    }

    public static List<String> LIST = Arrays.stream(ARRAY)
            .map(o -> (String) o[1]).collect(Collectors.toList());

    public static List<Integer> RGBLIST = Arrays.stream(ARRAY)
            .map(o -> (Integer) o[0]).collect(Collectors.toList());
    ...
    public static void show(Map<Integer, String> map, int count) {
        map.entrySet().stream().limit(count).forEach(HTMLColors::show);
    }
    ...
    public static void showInv(Map<String, Integer> map, int count) {
        INVERT_MAP.entrySet()
                .stream()
                .limit(count)
    ...
    public static void showInv(Map<String, Integer> map) {
        showInv(map, map.size());
    }
